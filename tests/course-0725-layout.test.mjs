...
test("classics reference is source-backed and ships with one fresh cache version",()=>{
  ...
  const coupledAssetVersions=[
    ...html.matchAll(/(?:href|src)="\.\/(?:styles\.css|course-0725\.js|course-0801\.js|course-0808\.js|course-0815\.js|course-0822\.js|course-0829\.js|course-0905\.js|training-bank\.js|app\.js)\?v=([^"]+)"/g)
  ].map(match=>match[1]);
  assert.deepEqual(
    coupledAssetVersions,
    Array(10).fill("20260912-fuyin-definition-v13"),
