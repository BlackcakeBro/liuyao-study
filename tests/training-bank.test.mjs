...
const source=["data.js","course-0718.js","course-0725.js","course-0801.js","course-0808.js","course-0815.js","course-0822.js","course-0829.js","course-0905.js","course-0912.js","training-bank.js"]
...
test("audited question bank covers foundation, all taught courses, and ancient annotations",()=>{
  ...
  assert.deepEqual(counts,{
    ...
    lecture0829:20,
    judgmentWealth:9,
    judgmentRelationship:9,
    classics:11
  });
  assert.equal(training.bank.length,487);
