...
这是与经典版隔离展示的课程新版，已同步核查至 2026-08-15 陈师课堂。

- 默认 URL 继续显示经典版，不展示新版课程页。
- 新版新增：旺衰关系、八宫卦谱、装卦六亲、按占问取用、六神、日月建，以及动静、空破、墓库与卦身。
- 7 月 25 日补完兑宫八卦取象，并整理装支原理、世应、六亲生克、父母爻与官鬼爻。
- 8 月 1 日补齐兄弟、妻财、子孙，整理按占问取用、世用关系，以及青龙、朱雀、勾陈、螣蛇、白虎、玄武的初步象意。
- 8 月 15 日补充动爻、旬空、月破、墓库、卦身与寻物例的观察顺序；后续反吟、伏吟、进神及用神案例仍待课堂。
- 8 月 22 日“断卦”已按完整录制复核：读取 02:35:05 屏幕共享画面与音轨，整理取用、元忌仇、飞伏、进退、伏反吟和应期；案例均作为知识点辅助，不作固定断语。
- 分层题库共 443 题。
